...
{
    public class UpdatePriceBaseSaleAndChannelOriginalPrice
    {
        readonly PriceApiHelper priceApiHelper;

        public UpdatePriceBaseSaleAndChannelOriginalPrice()
        {
            priceApiHelper = new PriceApiHelper();
        }
        
        // Mock price keys and New base sale and channel original price.
        ...
        async Task SetupBasePrice(string channel, string store, string sku)
        {
            var updateBasePrice = priceApiHelper.UpdatePrice(null, store, sku,
                null, MockTestPrices.BaseSalePriceVat, null,
        ...
        [Fact]
        public async Task BaseSaleAndChannelOriginalPrice_UpdateAllNullPrice_PriceDontChange()
        {
            // Arrange
            const string channel = Channel;
            const string store = Store;
            const string sku = "SC00001";
            ...
            const string expectExpDetail = "Invalid payload detected, .10138:SC00001 has no prices.";
        ...
        [Fact]
        public async Task BaseSaleAndChannelOriginalPrice_UpdateBaseOriginalPrice_PriceChange()
        {
            // Arrange
            const string channel = Channel;
            const string store = Store;
            const string sku = "SC00002";
        ...
        [Fact]
        public async Task BaseSaleAndChannelOriginalPrice_UpdateBaseSalePrice_PriceCombine()
        {
            // Arrange
            const string channel = Channel;
            const string store = Store;
            const string sku = "SC00003";
        ...
        [Fact]
        public async Task BaseSaleAndChannelOriginalPrice_UpdateBasePromotionPrice_PriceCombine()
        {
            // Arrange
            const string channel = Channel;
            const string store = Store;
            const string sku = "SC00004";
        ...
        [Fact]
        public async Task BaseSaleAndChannelOriginalPrice_UpdateChannelOriginalPrice_PriceCombine()
        {
            // Arrange
            const string channel = Channel;
            const string store = Store;
            const string sku = "SC00005";
        ...
        [Fact]
        public async Task BaseSaleAndChannelOriginalPrice_UpdateBaseOriginalAndSalePrice_PriceCombine()
        {
            // Arrange
            const string channel = Channel;
            const string store = Store;
            const string sku = "SC00006";
        ...
        [Fact]
        public async Task BaseSaleAndChannelOriginalPrice_UpdateBaseOriginalAndPromotionPrice_PriceCombine()
        {
            // Arrange
            const string channel = Channel;
            const string store = Store;
            const string sku = "SC00007";
        ...
        [Fact]
        public async Task BaseSaleAndChannelOriginalPrice_UpdateBaseOriginalAndChannelOriginalPrice_PriceCombine()
        {
            // Arrange
            const string channel = Channel;
            const string store = Store;
            const string sku = "SC00008";
        ...
        [Fact]
        public async Task BaseSaleAndChannelOriginalPrice_UpdateBaseSaleAndPromotionPricePrice_PriceCombine()
        {
            // Arrange
            const string channel = Channel;
            const string store = Store;
            const string sku = "SC00009";
        ...
        [Fact]
        public async Task BaseSaleAndChannelOriginalPrice_UpdateBaseSaleAndChannelOriginalPrice_PriceCombine()
        {
            // Arrange
            const string channel = Channel;
            const string store = Store;
            const string sku = "SC00010";
        ...
        [Fact]
        public async Task BaseSaleAndChannelOriginalPrice_UpdateBasePromotionAndChannelOriginalPrice_PriceCombine()
        {
            // Arrange
            const string channel = Channel;
            const string store = Store;
            const string sku = "SC00011";
        ...
        [Fact]
        public async Task BaseSaleAndChannelOriginalPrice_UpdateBaseOriginalSaleAndPromotionPrice_PriceCombine()
        {
            // Arrange
            const string channel = Channel;
            const string store = Store;
            const string sku = "SC00012";
        ...
        [Fact]
        public async Task BaseSaleAndChannelOriginalPrice_UpdateBaseOriginalSaleAndChannelOriginalPrice_PriceCombine()
        {
            // Arrange
            const string channel = Channel;
            const string store = Store;
            const string sku = "SC00013";
        ...
        [Fact]
        public async Task BaseSaleAndChannelOriginalPrice_UpdateBaseOriginalPromotionAndChannelOriginalPrice_PriceCombine()
        {
            // Arrange
            const string channel = Channel;
            const string store = Store;
            const string sku = "SC00014";
        ...
        [Fact]
        public async Task BaseSaleAndChannelOriginalPrice_UpdateBaseSalePromotionAndChannelOriginalPrice_PriceCombine()
        {
            // Arrange
            const string channel = Channel;
            const string store = Store;
            const string sku = "SC00015";
        ...
        [Fact]
        public async Task BaseSaleAndChannelOriginalPrice_UpdateBaseOriginalSalePromotionAndChannelOriginalPrice_PriceCombine()
        {
            // Arrange
            const string channel = Channel;
            const string store = Store;
            const string sku = "SC00016";
